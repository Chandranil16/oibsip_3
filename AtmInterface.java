...
public class AtmInterface {
    ...
    static void deposit(double amt) {
        if (amt <= 100000.00) {
            balance = balance + amt;
            System.out.println("^_^ Rs. " + amt + " deposited Successfully ^_^");
        } else {
            System.out.println("\n!!Limit Exceeded!!");
        }
    }
    ...
    static void withdraw(double amt) {
        if (balance >= amt) {
            balance = balance - amt;
            System.out.println("^_^ Rs. " + amt + " Withdrawn Successfully ^_^");
        } else {
        ...
        if (pin != password) {
            ...
            while (true) {
                ...
                switch (choice) {
                    ...
                    case 2:
                        System.out.println("Enter amount to be deposited (in Rs.): ");
                        double deposit_amount = sc.nextDouble();
                        deposit(deposit_amount);
                        break;

                    case 3:
                        System.out.println("Enter  amount to be withdrawn (in Rs.): ");
